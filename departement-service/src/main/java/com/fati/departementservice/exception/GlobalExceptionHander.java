package com.fati.departementservice.exception;
...
//    ResponseEntity<ErrorDetails> handleEmailAlreadyExitsException(EmailAlreadyExistsException exception, WebRequest webRequest) {
//        ErrorDetails errorDetails = new ErrorDetails(
//                LocalDateTime.now(),
//                exception.getMessage(),
//                webRequest.getDescription(false),
